...
class TestUserStory10Class(unittest.TestCase):
    ...
    def test_user_story_10_4(self):
        ...
        self.assertEqual(resultsList, ["ERROR: FAMILY: US10: F1: Wife (I2) birth date 1946-09-22 not at least 14 years prior to marriage date 1958-04-12"])

    def test_user_story_10_5(self):

        resultsList = userStory10("InputGedFiles/UserStory10_GED/FamilyTree_Test_ThreeUnder14.ged")
        self.assertEqual(resultsList, ["ERROR: FAMILY: US10: F1: Wife (I2) birth date 1946-09-22 not at least 14 years prior to marriage date 1958-04-12",
                                        "ERROR: FAMILY: US10: F2: Wife (I4) birth date 1977-05-09 not at least 14 years prior to marriage date 1987-05-09",
                                        "ERROR: FAMILY: US10: F3: Wife (I5) birth date 1976-12-26 not at least 14 years prior to marriage date 1990-12-24"])

    def test_user_story_10_6(self):

        resultsList = userStory10("InputGedFiles/UserStory10_GED/FamilyTree_Test_JustUnder14.ged")
        self.assertEqual(resultsList, ["ERROR: FAMILY: US10: F3: Wife (I5) birth date 1976-12-26 not at least 14 years prior to marriage date 1990-12-24"])
