...
class TestUserStory06Class(unittest.TestCase):
    ...
    def test1_UserStory6(self):
        resultsList = Story6("death_divorcebefore.ged")
        self.maxDiff = None
        self.assertEqual(resultsList, [])

    def test2_UserStory6(self):
        resultsList = Story6("deathbeforeDIV.ged")
        self.maxDiff = None
    ...
    def test3_UserStory6(self):
        resultsList = Story6("deathbeforeDIV_wife.ged")
        self.maxDiff = None
    ...
    def test4_UserStory6(self):
        resultsList = Story6("normal.ged")
        self.maxDiff = None
        self.assertEqual(resultsList, [])

    def test5_UserStory6(self):
        resultsList = Story6("husband.ged")
        self.maxDiff = None
