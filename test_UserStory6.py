import unittest
from sprint1UserStories import Story06

class TestUserStory06Class(unittest.TestCase):

    def test1_UserStory06(self):
        resultsList = Story06("InputGedFiles/UserStory06_GED/death_divorcebefore.ged")
        self.maxDiff = None
        self.assertEqual(resultsList, [])

    def test2_UserStory06(self):
        resultsList = Story06("InputGedFiles/UserStory06_GED/deathbeforeDIV.ged")
        self.maxDiff = None
    ...
    def test3_UserStory06(self):
        resultsList = Story06("InputGedFiles/UserStory06_GED/deathbeforeDIV_wife.ged")
        self.maxDiff = None
    ...
    def test4_UserStory06(self):
        resultsList = Story06("InputGedFiles/UserStory06_GED/normal.ged")
        self.maxDiff = None
        self.assertEqual(resultsList, [])

    def test5_UserStory06(self):
        resultsList = Story06("InputGedFiles/UserStory06_GED/husband.ged")
        self.maxDiff = None
