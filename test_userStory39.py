...
class UserStory39Test(unittest.TestCase):
    ...
    def test_userStory39_2(self):
        ...
        self.assertEqual(["FAMILY: US39: F1 has an upcoming anniversary on 12-20.", 
                        "FAMILY: US39: F2 has an upcoming anniversary on 12-20."], resultsList)

    def test_userStory39_3(self):

        resultsList = userStory39("InputGedFiles/UserStory39_GED/FamilyTree_All.ged")
        self.assertEqual(["FAMILY: US39: F1 has an upcoming anniversary on 12-20.", 
                        "FAMILY: US39: F2 has an upcoming anniversary on 12-20.",
                        "FAMILY: US39: F3 has an upcoming anniversary on 12-20.",
                        "FAMILY: US39: F4 has an upcoming anniversary on 12-20."], resultsList)
