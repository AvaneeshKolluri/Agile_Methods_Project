import unittest
from refactored import userStory05
...
class TestUserStory05Class(unittest.TestCase):
    ...
    def test1_UserStory05(self):
        ...
        self.maxDiff = None
        self.assertEqual(resultsList, ['Error: wedding occurs after wife death. Wedding Date: 2080-02-02 Wife Death: 2040-02-01'])

    def test2_UserStory05(self):
        resultsList = userStory05("InputGedFiles/UserStory05_GED/deathHusbandafter.ged")
        self.maxDiff = None
        self.assertEqual(resultsList, ['Error: wedding occurs after husband death. Wedding Date: 2080-02-02 Husband Death: 2050-01-05'])
