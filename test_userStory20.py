...
class UserStory20Test(unittest.TestCase):
    ...
    def test_userStor20_2(self):
        ...
        self.assertEqual(['ERROR: FAMILY: US20: 80: F2: Wife (I3) married nephew (I6)'], resultsList)

    def test_userStory20_3(self):

        resultsList = userStory20('InputGedFiles/UserStory20_GED/FamilyTree_MarriedNiece.ged')
        self.assertEqual(['ERROR: FAMILY: US20: 117: F3: Husband (I6) married niece (I9)'], resultsList)
    ...
    def test_userStory20_4(self):
        ...
        self.assertEqual(['ERROR: FAMILY: US20: 168: F3: Husband (I6) married niece (I9)', 'ERROR: FAMILY: US20: 187: F6: Wife (I12) married nephew (I14)'], resultsList)
