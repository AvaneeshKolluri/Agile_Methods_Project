...
class TestUserStory11Class(unittest.TestCase):
    ...
    def test_user_story_11_2(self):
        ...
        self.assertEqual(resultsList,['ERROR: FAMILY: US11: 125: F2: Marriage 1993-12-31 should not be happening during another marriage 1992-05-09.'])
    ...
    def test_user_story_11_4(self):
        ...
        self.assertEqual(resultsList, ["ERROR: FAMILY: US11: 182: F6: Marriage 1990-12-24 should not be happening during another marriage 1987-05-09.",
                                       "ERROR: FAMILY: US11: 182: F6: Marriage 2006-11-18 should not be happening during another marriage 1990-12-24."])
