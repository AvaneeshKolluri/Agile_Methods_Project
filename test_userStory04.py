...
class TestUserStory04Class(unittest.TestCase):
    ...
    def test_UserStory04_2(self):
        ...
        self.assertEqual(resultsList, ['ERROR: FAMILY: US04: 45: F1 Divorce date occurs before marriage date - Marriage 1000-01-03: Divorce 1000-01-01'])

    def test_UserStory04_3(self):
        resultsList = userStory04("InputGedFiles/UserStory04_GED/testUserStory04-3.ged")
        self.assertEqual(resultsList, ['ERROR: FAMILY: US04: 45: F1 Divorce date occurs before marriage date - Marriage 1000-02-01: Divorce 1000-01-01',
                                       'ERROR: FAMILY: US04: 53: F2 Divorce date occurs before marriage date - Marriage 1100-01-01: Divorce 1000-01-01'])
