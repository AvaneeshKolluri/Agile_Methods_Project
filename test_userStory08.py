...
class TestUserStory08Class(unittest.TestCase):
    ...
    def test_UserStory08_4(self):
        ...
        self.maxDiff = None
        self.assertEqual(resultsList, [ "ANOMALY: FAMILY: US08: F1: Child I6 born 1870-10-31 before marriage on 1997-12-31",
                                        "ANOMALY: FAMILY: US08: F1: Child I5 born 1853-07-08 before marriage on 1997-12-31",
