...
class TestUserStory14Class(unittest.TestCase):
    ...
    def test_UserStory14_2(self):
        ...
        self.assertEqual(resultsList, [ "ERROR: FAMILY: US14: 157: Family F1 has 6 children ['I14', 'I15', 'I4', 'I5', 'I6', 'I7'] born at the same time with age 1020.",
                                        "ERROR: FAMILY: US14: 164: Family F2 has 5 children ['I10', 'I11', 'I12', 'I13', 'I9'] born at the same time with age 1020."])
